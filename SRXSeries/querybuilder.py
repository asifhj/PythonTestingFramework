...
class Querybuilder:
    ...
    def build_sys_stats_data_query(self, sys_stats_data):
        chassisname = sys_stats_data.get("chassisname", 0)
        arpdiscarded = sys_stats_data.get("arpdiscarded", 0)
        arpdenied = sys_stats_data.get("arpdenied", 0)
        self.command_query = ""
        self.command_query = "  and arpdiscarded="+str(arpdiscarded)+" " \
            " and arpdenied="+str(arpdenied)+" "
